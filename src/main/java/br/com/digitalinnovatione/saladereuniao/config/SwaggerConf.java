package br.com.digitalinnovatione.saladereuniao.config;
...
public class SwaggerConf {
    ...
    private static final String BASE_PACKAGE = "br.com.digitalinnovatione.saladereuniao.controller";
    private static final String API_TITLE = "Sala de Reunião API";
